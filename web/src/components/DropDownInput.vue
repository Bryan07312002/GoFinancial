<template>
    <div class="flex flex-col text-[var(--neutral-100)]">
...
const props = defineProps<{
    value: string | number,
    options: (string | { value: string | number, label: string, disabled?: boolean })[]
    label?: string,
    placeholder?: string,
    disabled?: boolean,
}>()
